...
public class PlacementGenerator : MonoBehaviour
{
    ...
    [SerializeField, Range(0, 1)] float rotationTowardNormal;
    ...
    public void Generate()
    {
        ...
        for(int i = 0; i < density; i++)
        {
            ...
            instantiatedPrefab.transform.rotation = Quaternion.Lerp(transform.rotation, transform.rotation * Quaternion.FromToRotation(instantiatedPrefab.transform.up, hit.normal), rotationTowardNormal);
...
//        PlacementGenerator generator = (PlacementGenerator)target;
